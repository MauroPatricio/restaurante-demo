...
export default function DashboardRedirect() {
    ...
    // Check for Cashier and Stock access
    ...
    // Direct Redirects for new Operational Roles
    if (isCashier) return <Navigate to="/dashboard/orders" replace />;
    if (isStock) return <Navigate to="/dashboard/stock-management" replace />;
